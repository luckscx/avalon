...
M.show_name = {
    "梅林", "梅林","梅林", "梅林","梅林", "梅林","梅林", "梅林","梅林", "梅林" 
}

-- 4: 表示只能看见派别，不能看见身份
M.visible = {
--   梅林   派西维尔     兰(正)  骑士   刺客  莫德雷德  莫甘娜  兰(邪)    奥伯伦  爪牙
   { false, false,     false,   false,     4,  false,       4,      4,        4,     4  },   --梅林
   { 5    , false,     false,   false, false,  false,       5,  false,    false, false  },  --派西维尔
   ...
   { false, false,         3,   false, false,  false,   false,  false,    false,  false },      --兰(邪)
